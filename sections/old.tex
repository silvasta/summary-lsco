...
% INFO: old version, just as lookup for formulas etc
...
\foreach \lecture / \recital / \summary in {
  ...
  \iftoggle{showLecture}{
    ...
    \ssthl{Start of Lecture}
    \input\lecture
    \ssthl{End of Lecture}
  }{}
  \iftoggle{showRecital}{
    \typeout{Including recital: \recital}
    \ssthl{Start of Recital}
    \input\recital
    \ssthl{End of Recital}
  }{}
  \iftoggle{showSummary}{
    \typeout{Including summary: \summary}
    \ssthl{Start of Summary}
    \input\summary
    \ssthl{End of Summary}
  }{}
}
