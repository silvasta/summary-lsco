...
Step 1: $\mathcal{L}(x,\lambda_1,\lambda_2) = c\T x-\lambda_1\T
(Ax-b) -\lambda_2\T x,\ \lambda_i \ge0$

Step 2:$\underset{x \in
\mathcal{\mathbb{R}}^n}{inf}\mathcal{L}(x,\lambda_1,\lambda_2)
=
\begin{cases} \lambda_1\T b & \text{if }c-A\T\lambda_1-\lambda_2=0  \\
  -\infty       & \text{if } c-A\T\lambda_1-\lambda_2=0
\end{cases}$

Step 3: Dual Problem (again linear programm)
\begin{equation}
  \begin{aligned}
    \operatorname{maximize}\  & b\T\lambda & \text{s.t.}\  &
