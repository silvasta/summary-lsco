...
\begin{equation}
  f^\star = \underset{x \in \mathcal{\mathbb{R}}^n}{inf}f(x) \text{
  s.t. } h(x)=0,\ g(x) \le 0
  \label{eq:dual}
\end{equation}
...
where $\lambda_i \ge 0, \nu_i \in \mathbb{R}$ are the dual variables
or multipliers
...
\begin{proposition}[Weak Duality]
  ...
  $d(\lambda,\nu) = \underset{x \in
  \mathcal{\mathbb{R}}^n}{inf}\mathcal{L}(x,\lambda,\nu)$ satisfies
...
\begin{theorem}[KKT Conditions]
  ...
  \mathbb{R}^{n_g}\times\mathbb{R}^{n_h}$ is a maximizer of the dual
  $\Leftrightarrow$
  $$
  \begin{aligned}
